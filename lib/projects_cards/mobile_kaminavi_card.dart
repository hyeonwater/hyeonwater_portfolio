...
class MobilekaminaviCard extends StatelessWidget {
  const MobilekaminaviCard({Key? key,required this.darkMode}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.only(bottom: 10),
                          child: Text(
                            "카미나비 앱은 프런트 개발자 3명, 백엔드 개발자 2명이서 개발을 진행하였습니다. 하지만 프런트 개발자 2명이 프로젝트 사정이 생겨 혼자 개발하는 상황이었습니다. 2명의 개발자의 코드들이 스타일이 제각기이므로 이번 프로젝트를 통해 클린 코드, 코드 리뷰의 중요성을 깨달았습니다.",
                            style: TextStyle(
                                color: darkMode ? Color(0xffFFFFFF) : Color(0xff2c2c2c),
                                fontWeight: FontWeight.w500,
                                fontFamily: "NotoSansCJKKR",
